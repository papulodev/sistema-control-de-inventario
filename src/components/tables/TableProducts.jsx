...
function TableProducts({ data, setOpenRegister, setDataSelect, setAction }) {
	const { deletingProduct } = useProductsStore();
		...
		},
		{
			...
			cell: (info) => (
				<div data-title="Categoria" className="ContentCell">
					<ColorcontentTable
						$color={info.row.original.category}
...
const ColorcontentTable = styled.div`
