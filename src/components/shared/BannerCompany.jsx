...
function BannerCompany() {
  ...
  const { dataCompany, usersConter } = useCompanyStore();
  ...
  return (
    <Container>
      <div className="content-wrapper-context">
        ...
        <ContentCards>
          <CardDataCompany title="Moneda" value={dataCompany?.symbol_currency} />

          <CardDataCompany title="Usuarios" value={usersConter} />
